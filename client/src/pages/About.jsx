...
const About = () => {
    ...
    return (
        <div className="min-h-screen bg-[#ECF6F5] text-slate-800 selection:bg-[#CDE9E6] selection:text-[#123C4A] font-sans overflow-x-hidden">
            ...
            <div className="relative min-h-[60vh] flex flex-col items-center justify-center px-4 text-center overflow-hidden">
                ...
                <div className="max-w-3xl mx-auto space-y-6 relative z-10">
                    <h1 className="text-5xl md:text-7xl font-bold font-serif text-[#123C4A] leading-tight tracking-tight">
                        Better care starts with <br />
                        <span className="text-[#0F9D8A]">earlier insight.</span>
                    </h1>
                    <p className="text-xl md:text-2xl text-[#325A67] max-w-2xl mx-auto font-medium leading-relaxed opacity-90">
                        NeuroSentinel helps patients and providers act faster with AI-assisted screening,
                        risk tracking, and coordinated care pathways.
                    </p>
                </div>
            </div>
            ...
            <section className="py-24 px-4 md:px-8 max-w-7xl mx-auto relative z-10">
                <div className="flex flex-col md:flex-row items-center gap-16">
                    ...
                    <div className="w-full md:w-1/2 space-y-8">
                        <div>
                            <h2 className="text-4xl md:text-5xl font-serif font-bold text-[#123C4A] mb-4">
                                Our Story
                            </h2>
                            <div className="w-20 h-2 bg-[#FFCC80] rounded-full opacity-60"></div>
                        </div>

                        <p className="text-[#325A67] text-xl leading-relaxed font-medium opacity-90">
                            Founded in 2026, NeuroSentinel was built around a clear challenge:
                            care teams need timely, interpretable signals to support patients before conditions escalate.
                        </p>

                        <p className="text-[#325A67] text-xl leading-relaxed font-medium opacity-90">
                            We combine compassionate design with clinically responsible technology
                            so screening, triage, follow-up, and communication stay connected end to end.
                        </p>
                        ...
                        <div className={`overflow-hidden transition-all duration-500 ease-in-out ${showPhilosophy ? 'max-h-[1000px] opacity-100 mt-8' : 'max-h-0 opacity-0'}`}>
                            <div className="bg-white/80 backdrop-blur-xl p-10 rounded-[2.5rem] border border-white/60 shadow-xl space-y-8">
                                <div>
                                    <h3 className="text-2xl font-serif font-bold text-[#123C4A] mb-3">The Challenge</h3>
                                    <p className="text-[#325A67] text-lg leading-relaxed font-medium opacity-80">
                                        Healthcare data is often fragmented across visits, forms, and systems.
                                        Without continuity, subtle risk trends are easy to miss until urgent care is required.
                                    </p>
                                </div>

                                <div>
                                    <h3 className="text-2xl font-serif font-bold text-[#123C4A] mb-3">Our Objective</h3>
                                    <p className="text-[#325A67] text-lg leading-relaxed font-medium mb-4 opacity-80">
                                        We are building a <strong className="text-[#00695C]">preventive, technology-driven care platform</strong> that:
                                    </p>
            ...
            {/* Mission & Values */}
            <section className="py-32 bg-[#E8F4F3] relative overflow-hidden">
                <div className="absolute top-[-100px] left-[-100px] w-96 h-96 bg-[#FFE0B2] rounded-full opacity-30 blur-3xl" />

                <div className="max-w-7xl mx-auto px-4 md:px-8 relative z-10">
                    <div className="text-center mb-20">
                        <h2 className="text-4xl md:text-6xl font-serif font-bold text-[#123C4A] mb-6">
                            Our Mission & Values
                        </h2>
                        <div className="w-24 h-2 bg-[#FFCC80] rounded-full mx-auto opacity-60 mb-6"></div>
                        <p className="text-[#325A67] max-w-2xl mx-auto text-xl font-medium opacity-80">
                            We are guided by principles that center patients, support clinicians,
                            and improve access to trusted healthcare.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
                        {[
                            {
                                title: "Patient First",
                                desc: "Accessible tools that help people understand risk, take action early, and stay informed.",
                                icon: Heart,
                                color: "text-[#EF6C00]",
                                bg: "bg-[#FFF3E0]"
                            },
                            {
                                ...
                                desc: "Stronger communication between patients, doctors, and support systems across the journey.",
                                icon: Users,
                                color: "text-[#6A1B9A]",
                                bg: "bg-[#F3E5F5]"
                            },
                            {
                                ...
                                desc: "Built with evidence-based workflows, transparent AI, and measurable care outcomes.",
                                icon: CheckCircle,
                                color: "text-[#00695C]",
                                bg: "bg-[#E0F2F1]"
                            }
                            ...
                            <div key={i} className="group bg-white/80 backdrop-blur-xl rounded-[2.5rem] p-10 shadow-lg hover:shadow-2xl transition-all duration-300 border border-white/60 hover:-translate-y-2">
                                ...
                                <h3 className="text-2xl font-serif font-bold mb-4 text-[#123C4A]">
                                    {value.title}
                                </h3>
                                <p className="text-[#325A67] text-lg leading-relaxed font-medium opacity-80">
                                    {value.desc}
            ...
            <section className="py-32 relative">
                <div className="max-w-5xl mx-auto px-4 text-center">
                    ...
                    <div className="mt-32 pt-12 border-t border-[#3E2723]/10">
                        <p className="text-[#123C4A] text-sm font-bold opacity-50 uppercase tracking-widest">
                            © {new Date().getFullYear()} NeuroSentinel • Care starts with access.
                        </p>
                    </div>
                </div>
            </section>
